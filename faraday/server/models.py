...
try:
    from faraday.domain.command.models import Command, CommandObject  # ponytail YAGNI: Command -> domain/command
    DOMAIN_COMMAND_AVAILABLE = True
except ImportError:
    DOMAIN_COMMAND_AVAILABLE = False
...
DOMAIN_WORKSPACE_AVAILABLE = False
try:
    from faraday.domain.workspace.models import (  # ponytail YAGNI: Workspace -> domain/workspace
        Scope,
        Workspace,
        WorkspacePermission,
    )
    DOMAIN_WORKSPACE_AVAILABLE = True
except ImportError:
    DOMAIN_WORKSPACE_AVAILABLE = False
...
try:
    from faraday.domain.notification.models import (  # noqa: F401
    ...
    )  # ponytail YAGNI: notification (16 clases) -> faraday/domain/notification
    DOMAIN_NOTIFICATION_AVAILABLE = True
except ImportError:
    DOMAIN_NOTIFICATION_AVAILABLE = False
...
try:
    from faraday.domain.agent_workflow.models import (  # ponytail YAGNI: agent_workflow -> domain/agent_workflow
        Agent,
        AgentExecution,
        AgentsSchedule,
        CloudAgent,
